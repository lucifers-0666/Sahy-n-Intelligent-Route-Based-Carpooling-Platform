...
void main() {
  group('Phase 2 Full-Stack Integration & State Architecture Tests', () {
    ...
    test('VehicleRepository deserializes MongoDB vehicles response formats', () {
    ...
    test('RideModel parses live MongoDB document with Driver and Route info', () {
      final mockRideJson = {
        '_id': 'ride_live_777',
        'driver': {
          '_id': 'usr_driver_77',
    ...
    test('BookingModel parses live booking with atomic status changes and security PIN', () {
      ...
      final bookingWithoutPin = BookingModel(
        ...
        pickup: const LocationModel(address: 'A', city: 'A', latitude: 0, longitude: 0),
        drop: const LocationModel(address: 'B', city: 'B', latitude: 0, longitude: 0),
